...
<body>
          ...
          -->
                            <div x-show="open" @click.outside="open = false"
                                ...
                                <a href="{{ route('products.myProducts') }}"
                                    ...
                                    tabindex="-1" id="user-menu-item-0">My Products</a>
                                <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
    ...
    <main class="w-full mx-auto px-8 pb-20 pt-5">
        @if (session('success'))
            <x-flashMsg message="{{ session('success') }}" type="success" />
        @endif
        @if (session('error'))
            <x-flashMsg message="{{ session('error') }}" type="error" />
        @endif
        {{ $slot }}
    </main>

    {{-- <footer class="text-center border-t border-gray-300 sticky">
    ...
    <footer class="bg-white dark:bg-gray-900 w-full mx-auto px-8 fixed bottom-0">
